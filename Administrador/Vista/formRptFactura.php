...
<body bgcolor="#cccccc">
    ...
    <div class="statictitulo"><div id="DivTitulos">Reportes de Facturas</div></div> 
   <div id="DivCuerpo">
       <div id="contenido">
           <center>
           <table border="0">
               <h1>Reporte de Facturas por Cobrar:</h1>
               <tbody>
                   <tr>
                       <td>Fecha Inicio: </td>
                       ...
                       <td> <input type="button" value="Ver" onclick="javascript:window.open('Reportes/rptListaFactura?fecha1='+document.getElementById('datepicker').value+'&fecha2='+document.getElementById('datepicker1').value);"/>
                       </td>
