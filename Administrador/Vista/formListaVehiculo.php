...
function verlistado(){ //FUNCION PARA MOSTRAR EL LISTADO EN EL INDEX POR JQUERY
            ...
            $.post("libs/listaVehiculoMan.php", {
...
<body bgcolor="#cccccc">
 ...
 <div class="statictitulo"><div id="DivTitulos">Lista Vehiculos</div></div>  
   <div id="DivCuerpo">
...
if (isset($_GET['item'])){
    ...
    $idvehiculo= $_GET['item'];
    
   $Nvehiculo->eliminarVehiculo($idvehiculo);
