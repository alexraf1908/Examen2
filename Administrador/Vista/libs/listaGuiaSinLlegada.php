...
$cliente=$guiar->listarSinLlegada();
...
<script type="text/javascript" language="javascript" src="js/jslistadopaises.js"></script>
     ...
     for($i=0;$i<count($cliente);$i++){
                               ...
                               echo '<td>'.$cliente[$i]['nombres'];'</td>';
                                       ...
                                       echo '<td><a href="formLlegada?codguia='.$cliente[$i]['idguia'].'" ><ACRONYM title="Registrar Llegada Vehiculo"><img src="Imagenes/play2.png" width="25" height="25" alt="editar"/></ACRONYM></a></td>';
