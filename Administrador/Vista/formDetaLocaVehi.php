...
<body bgcolor="#cccccc">
 ...
 <div class="statictitulo"><div id="DivTitulos">Lista Detalle Localizacion</div></div>  
   <div id="DivCuerpo">
       ...
       <div id="contenido">
           ...
           <center><table border="0">
               ...
               <tbody>
                   <tr>
                       <td>PlacaVehiculo:</td>
                       <td><input type="text" name="idplaca" value="" id="idplaca" /></td>
                       ...
                       <td><a style= 'cursor:pointer;color:blue;'><img src="Imagenes/buscar.png" width="50" height="50" alt="eliminar" onclick="ListarLocalizacion();"/></a> 
                       </td>
                   </tr>
               </tbody>
           </table></center>
